...
COPY aircraft_type FROM '/app/aircraft_type.csv' WITH (FORMAT csv, HEADER true);
...
COPY aircraft_layout(type_id, y_class_capacity, j_class_capacity, f_class_capacity) FROM '/app/aircraft_layout.csv' WITH (FORMAT csv, HEADER true);
...
COPY aircraft FROM '/app/aircraft.csv' WITH (FORMAT csv, HEADER true);
...
COPY country FROM '/app/country.csv' WITH (FORMAT csv, HEADER true);
...
COPY city FROM '/app/city.csv' WITH (FORMAT csv, HEADER true);
...
COPY airport FROM '/app/airport.csv' WITH (FORMAT csv, HEADER true);
...
COPY flight(flight_id, origin, destination, aircraft, departure_utc, duration, y_price, j_price, f_price) FROM '/app/flight.csv' WITH (FORMAT csv, HEADER true);
